...
def trend_cols(scope, screener_df, test):
	...
	column 		= scope.screener_tests[test]['metrics']['column']
	trend 		= scope.screener_tests[test]['metrics']['trend']
	duration	= int(scope.screener_tests[test]['metrics']['duration'])
	timespan 	= int(scope.screener_tests[test]['metrics']['timespan'])
