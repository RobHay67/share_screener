...
def view_industries(scope):
	...
	list_of_industries = sorted(scope.data['ticker_index']['industry_group'].unique())


	for industry in list_of_industries:
		industry_df = scope.data['ticker_index'][scope.data['ticker_index']['industry_group'] == industry ]
