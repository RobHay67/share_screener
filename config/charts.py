...
chart_schema = {
		# Primary Charts -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		'candlestick'		: { active:False, name:'CandleStick'		, overlay:False	, plot:{ function:candle_plot 	, title:'Price'		, height:2, yaxis:'$,.2f' 	}, 	data_cols:None, },
		...
		'sma_3' 			: { active:False, name:'SMA-3'				, overlay:True	, plot:{ function:sma_plot, colour:'green' 		}, 									data_cols:{ function:sma_cols, column:'close', periods:200	} },
		'ema_1' 			: { active:False, name:'EMA-1'				, overlay:True	, plot:{ function:ema_plot, colour:'red'  		}, 									data_cols:{ function:ema_cols, column:'close', periods:21 	} },
		...
		'ema_3' 			: { active:False, name:'EMA-3'				, overlay:True	, plot:{ function:ema_plot, colour:'SteelBlue' 	}, 									data_cols:{ function:ema_cols, column:'close', periods:200 } },
		'bollinger_bands' 	: { active:False, name:'Bollinger Bands'	, overlay:True	, plot:{ function:sma_plot, colour:'black' 		}, 									data_cols:{ function:ema_cols, column:'close', length:20, shift_up:2, shift_down:2, m_a_type:'simple', } },
		'dividends' 		: { active:False, name:'Dividends'			, overlay:True	, plot:{ function:sma_plot, colour:'black' 		}, 									data_cols:None },		# TODO - we could still plot into the plot_df
		'announcements' 	: { active:False, name:'Announcements'		, overlay:True	, plot:{ function:sma_plot, colour:'black' 		}, 									data_cols:None },		# TODO - we are still going to need a chart here
		'ichi_moku' 		: { active:False, name:'Icki Moku' 			, overlay:True	, plot:{ function:sma_plot, colour:'black' 		}, 									data_cols:None },		# TODO - Rob to work out if this needs speccing
		'ichi_moku_daily'	: { active:False, name:'Icki Moku Daily'	, overlay:True	, plot:{ function:sma_plot, colour:'black' 		}, 									data_cols:None },		# TODO - Rob to work out if this needs speccing
