...
chart_schema = {
		# Primary Charts -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		'candlestick'		: { active:True , name:'CandleStick'		, overlay:False	, plot:{ function:candle_plot 	, title:'Price'		, height:1 }, data_cols:None, },
		'scatter'			: { active:False, name:'Scatter'			, overlay:False	, plot:{ function:None			, title:''			, height:1 }, data_cols:None, },
		'bar'				: { active:False, name:'Bar'				, overlay:False	, plot:{ function:None			, title:''			, height:1 }, data_cols:None, },
		'line'				: { active:False, name:'Line charts'		, overlay:False	, plot:{ function:None			, title:''			, height:1 }, data_cols:None, },
		'heiken_ashi'		: { active:False, name:'Heikin Ashi'		, overlay:False	, plot:{ function:None			, title:''			, height:1 }, data_cols:None, },
		# Secondary Charts -----------------------------------------------------------------------------------------------------------------------------------------------------------------------
		'volume'			: { active:True , name:'Volume'				, overlay:False	, plot:{ function:volume_plot	, title:'Volume'	, height:1 }, data_cols:None, },
		'vol_per_minute'	: { active:False, name:'Volume Per Minute'	, overlay:False	, plot:{ function:vpm_plot		, title:''			, height:1 }, data_cols:None, },  # TODO is this a chart or on overlay - maybe just to the volume chart - I dont know
		'vac'				: { active:False, name:'VAC'				, overlay:False	, plot:{ function:None			, title:''			, height:1 }, data_cols:None, },
		'macd'				: { active:False , name:'MACD'				, overlay:False	, plot:{ function:macd_plot		, title:'MACD'		, height:1 }, data_cols:{ function:macd_cols	, column:'close', long:26, short:12, signal:9 } },
		'rsi'				: { active:False , name:'RSI'				, overlay:False	, plot:{ function:rsi_plot		, title:''			, height:1 }, data_cols:{ function:rsi_cols		, column:'close', periods:10, }, },
		'vol_osssy'			: { active:False, name:'Volume Oscillator'	, overlay:False , plot:{ function:None 			, title:''			, height:1 }, data_cols:{ function:None			, column:'volume', fast:14, slow:21 } },
		'stochastic'		: { active:False , name:'Stochastic'		, overlay:False , plot:{ function:stoch_plot	, title:'Stochastic', height:1 }, data_cols:{ function:stoch_cols	, lookback_days:14, slow:3, signal:3 } },
		# Overlays ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
