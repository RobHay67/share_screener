...
def show_config_pages(scope):
	logging.debug("show_config_pages")
	...
	with col1:show_config_note("loaded_ticker_list", 'list of every ticker ever loaded for this page')
	with col2:show_config_note("selected_tickers", 'list of tickers determined by the Selectors')
	# with col4:show_config_note("loaded_ticker_list", 'list of every ticker ever loaded for this page')
	with col4:show_config_note("search_results", 'list of ticker names which match the search string')
	with col5:scope_button(scope, "scope.page["+page+"]['show']['trials']", scope.page[page]['show']['trials'])
	with col6:scope_button(scope, "scope.page["+page+"]['show']['strategy']", scope.page[page]['show']['strategy'])
	with col7:scope_button(scope, "scope.page["+page+"]['show']['charts']", scope.page[page]['show']['charts'])
	with col8:scope_button(scope, "scope.page["+page+"]['show']['overlays']", scope.page[page]['show']['overlays'])
	with col9:scope_button(scope, "scope.page["+page+"]['show']['config']", scope.page[page]['show']['config'])
	with col10:scope_button(scope, "scope.page["+page+"]['show']['ticker_file']", scope.page[page]['show']['ticker_file'])
