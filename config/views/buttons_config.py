...
def show_config_buttons(scope):
	...
	with col2: 
		st.button('Page', use_container_width=True, on_click=set_st_button, args=(scope, 'show_page_config', ))
	...
	with col5: 
		st.button('Trials', 			use_container_width=True, on_click=set_st_button, args=(scope, 'show_trial_global_config', ))
