...
chart_schema = {
		...
		'vol_per_minute'	: { 
								...
								data_cols		: None, 					# TODO is this a chart or on is_overlay - maybe just to the volume chart - I dont know
								},  
		'vac'				: { 
								active			: False, 
								name			: 'VAC', 
		...
		'sma_1' 			: { 
								...
								data_cols		: {	function : sma_cols, column : 'close', periods:21 } 
								},		
		'sma_2' 			: { 
								active			: False, 
								name			: 'SMA-2', 
								...
								data_cols		: {	function : sma_cols, column : 'close', periods:50 } 
								},		
		'sma_3' 			: { 
								active			: False, 
								name			: 'SMA-3', 
								...
								apply_overlay	: False, 
								plot			: { function : sma_plot, colour : 'green' }, 									
								data_cols		: {	function : sma_cols, column : 'close', periods:200 } 
								},		
		'ema_1' 			: { 
								active			: False, 
								name			: 'EMA-1', 
								...
								data_cols		: {	function : ema_cols, column : 'close', periods:21 } 
								},
		'ema_2' 			: { 
								active			: False, 
								name			: 'EMA-2', 
								...
								data_cols		: {	function : ema_cols, column : 'close', periods:50 } 
								},
		'ema_3' 			: { 
								active			: False, 
								name			: 'EMA-3', 
								...
								data_cols		: {	function : ema_cols, column : 'close', periods:200 } 
								},
		'bollinger_bands' 	: { 
								active			: False, 
		...
		'announcements' 	: { 
								...
								data_cols		: None,			 # TODO - we are still going to need a chart here
								},		
		'ichi_moku' 		: { 
								active			: False, 
								name			: 'Icki Moku', 
								...
								data_cols		: None 			# TODO - Rob to work out if this needs speccing
								},		
		'ichi_moku_daily'	: { 
								active			:False, 
