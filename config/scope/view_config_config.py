...
def show_config_config(scope):
	...
	col1,col2,col3,col4,col5,col6,col7,col8,col9 = st.columns([1.5,1.5,1,1,1,1,1,1,1])
	...
	with col5:scope_button(scope, "scope.config['page_list']", scope.config['page_list'])
	with col6:scope_button(scope, "scope.config['ticker_search']", scope.config['ticker_search'])
	with col7:scope_button(scope, "scope.config['row_limit']", scope.config['row_limit'])
	...
	with col7:show_config_single_value("row_limit", scope.config['row_limit'])
