...
from trials.scope.settings.ohlcv import ohlcv_price_direction
from trials.scope.settings.sma import sma_trends
from trials.scope.settings.stochastic import stochastic_trend
from trials.scope.settings.rsi import rsi_trends
from trials.scope.settings.example import example_settings
