...
def edit_colour(scope, config_group, config_key ):
	...
	display_name =  ('Colour for ' + scope[config_group]['user_config'][config_key]['short_name'])
	previous_selection = scope[config_group]['user_config'][config_key]['plot']['colour']
...
def on_change_colour_selection(scope:dict, config_group:str, config_key:str, widget_key:str):
	...
	# store the selection
	scope[config_group]['user_config'][config_key]['plot']['colour'] = changed_value	
