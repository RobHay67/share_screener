...
def looks_like_i_deleted_thje_function_name(scope)
	...
	with col2: ema_cols = st.multiselect('column(s)', scope.config['dropdowns']['ticker']_columns, default='close', help='choose a column', key='21')
	...
	with col3: macd_cols = st.multiselect('column(s)', scope.config['dropdowns']['ticker']_columns, default='close', help='choose a column', key='33')
	...
	with col4: rsi_cols = st.multiselect('column(s)', scope.config['dropdowns']['ticker']_columns, default='close', help='choose a column', key='42')
...
def alternative_indicators(scope):
	...
	with col3: sma_cols = st.multiselect('s', scope.config['dropdowns']['ticker']_columns, default='close', help='choose a column', key='sma_cols11')
