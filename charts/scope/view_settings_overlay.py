...
from charts.scope.settings.announcements import announcement_settings
from charts.scope.settings.bollinger_bands import bollinger_band_settings
from charts.scope.settings.dividends import dividend_settings
from charts.scope.settings.moving_average import moving_average_settings



def show_settings_overlay(scope):
	logging.warning("show_settings_overlay")
	# ----------------------------------------------------------------------
	# Overlays
	# ----------------------------------------------------------------------	
