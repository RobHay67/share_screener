...
def stoch_cols( scope, chart, ticker, chart_df):
	...
	slow_k 			= scope.charts['user_config'][chart]['function']['slow']
...
def stochastic_trend( scope, trial, ticker, df):
	...
	signal 			= scope.trials['user_config'][trial]['function']['signal']
	slow_k 			= scope.trials['user_config'][trial]['function']['slow']
