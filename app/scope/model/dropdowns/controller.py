...
from app.scope.model.dropdowns.markets import build_market_dropdown_list
from app.scope.model.dropdowns.industries import build_inductry_dropdown_list
from app.scope.model.dropdowns.tickers import build_ticker_dropdown_list
