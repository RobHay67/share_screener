...
def show_app_config(scope):
	...
	col1,col2,col3,col4,col5,col6,col7,col8,col9 = st.columns(9)
	with col6:show_scope_single_value("row_limit", scope.config['row_limit'])
	with col7:show_scope_single_value("display", scope.config['display'])
	with col8:show_scope_single_value("share_market", scope.config['share_market'])
	with col9:show_scope_single_value("download_days", scope.config['download_days'])
