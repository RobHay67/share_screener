...
def show_scope_page(scope):
	...
	with col8:scope_button(scope, "scope.page["+page+"]['render']['app_scope']", scope.page[page]['render']['app_scope'])
	with col9:scope_button(scope, "scope.page["+page+"]['render']['strategy']", scope.page[page]['render']['strategy'])

	col1,col2,col3,col4,col5,col6,col7,col8,col9 = st.columns([4,1,1,1,1,1,1,1,1])
	with col2:show_scope_single_value("chart_settings", scope.page[page]['render']['chart_settings'])
	with col3:show_scope_single_value("overlay_settings", scope.page[page]['render']['overlay_settings'])
	with col4:show_scope_single_value("trial_settings", scope.page[page]['render']['trial_settings'])
	with col5:show_scope_single_value("strategy", scope.page[page]['render']['strategy'])
	with col6:show_scope_single_value("ticker_file", scope.page[page]['render']['ticker_file'])
	with col7:show_scope_single_value("page_config", scope.page[page]['render']['page_config'])
	with col8:show_scope_single_value("app_scope", scope.page[page]['render']['app_scope'])
	with col9:show_scope_single_value("ticker_config", scope.page[page]['render']['ticker_config'])
