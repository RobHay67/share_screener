...
def show_scope_page(scope):
	...
	col1,col2,col3,col4,col5,col6,col7,col8,col9 = st.columns([4,1,1,1,1,1,1,1,1])
	with col2:show_scope_single_value("settings_trials", scope.page[page]['show']['settings_trials'])
	with col3:show_scope_single_value("strategy", scope.page[page]['show']['settings_strategy'])
	with col4:show_scope_single_value("settings_charts", scope.page[page]['show']['settings_charts'])
	with col5:show_scope_single_value("settings_overlay", scope.page[page]['show']['settings_overlay'])
	with col6:show_scope_single_value("config_ticker_data", scope.page[page]['show']['config_ticker_data'])
	with col7:show_scope_single_value("config_page", scope.page[page]['show']['config_page'])
	with col8:show_scope_single_value("scope", scope.page[page]['show']['scope'])
	with col9:show_scope_single_value("ticker_file", scope.page[page]['show']['ticker_file'])
