...
def show_config_pages(scope):
	...
	with col6:scope_button(scope, "scope.page["+page+"]['show']['config_to_show']", scope.page[page]['show']['config_to_show'])
	...
	with col6:show_config_single_value("config_to_show", scope.page[page]['show']['config_to_show'])
