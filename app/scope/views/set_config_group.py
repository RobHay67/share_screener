...
def show_config_group_selection_buttons(scope):
	...
	with col1: 
		st.button('Summary', 			use_container_width=True, on_click=set_st_button, args=(scope, 'show_scope_summary', ))
		st.button('Config (App)', use_container_width=True, on_click=set_st_button, args=(scope, 'show_scope_config', ))
	with col2: 
	...
	with col4: 	
		st.button('Tickers (Data)',		use_container_width=True, on_click=set_st_button, args=(scope, 'show_scope_tickers', ))
		st.button('Ticker Schema', 		use_container_width=True, on_click=set_st_button, args=(scope, 'show_scope_tickers_schema', ))
	with col5: 
	...
	with col6:
		...
		st.button('Charts (WIP - add overlays)', 			use_container_width=True, on_click=set_st_button, args=(scope, 'show_scope_chart', ))
