...
# 	Ticker Screener Data is stored in 	< scope.page[page].screener_df >		ie scope.page['chart'].screener_df
#	Chart Data is stored in 			< scope.page[page].chart_df > 			ie scope.page['chart'].chart_df
