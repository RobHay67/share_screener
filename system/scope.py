...
from system.download import scope_download, view_download
...
from system.user import scope_user, view_user
...
def view_scope(scope):
	# view_user_settings(scope)
	view_application_settings(scope)
	if st.session_state.st_button != None:
		view_selected_scope_page(scope)
...
def view_application_settings(scope):
...
def view_selected_scope_page(scope):
