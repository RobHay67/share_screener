...
from params import set_session_variables, construct_list_of_share_codes, show_application_params
...
# TODO - getting an error right here on the initial load - might need to check if this is the first run as we may not have this information
print (st.session_state.available_industries )
print ( '*'*120)
...
application_params = st.sidebar.button('Application Parameters')

st.info('State of application buttun = ' + str(application_params))

# TODO - we need to retain the state of these buttons for each subsequent run

if application_params:
	show_application_params()
