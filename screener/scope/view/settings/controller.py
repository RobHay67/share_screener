...
from screener.scope.view.settings.ohlcv import ohlcv_price_direction
from screener.scope.view.settings.sma import sma_trends
from screener.scope.view.settings.stochastic import stochastic_trend
from screener.scope.view.settings.rsi import rsi_trends
