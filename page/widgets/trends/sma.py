...
from trials.scope.model.schema import trends_for_sma


def edit_trend_sma(scope, schema_group, schema_key ):
	logging.debug("edit_trend_sma")
	...
	st.selectbox ( 
					...
					on_change	=changed_sma_selection,
					args		=(scope, schema_group, schema_key, widget_key, ),
					key			=widget_key,
					) 


def changed_sma_selection(scope:dict, schema_group:str, schema_key:str, widget_key:str):
	logging.warning("changed_sma_selection")
