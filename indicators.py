...
# --------------------------------------------------------------------------------------------------------------------------------------------------------------
# Trend Line Columns - Naming Convention Helpers - what was the original column name
# --------------------------------------------------------------------------------------------------------------------------------------------------------------
def determine_original_column_name( column ):
	last_letter = column[-1]
	col = 'unknown'
	if last_letter == 'o': col = 'close'
	if last_letter == 'h': col = 'high'
	if last_letter == 'l': col = 'low'
	if last_letter == 'c': col = 'close'
	if last_letter == '\\': col = 'volume'
	return col
