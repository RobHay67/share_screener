...
def show_config_ticker_index(scope):
	...
	col1,col2,col3,col4,col5,col6 = st.columns([3,1,1,1,1,1])
	with col2:show_config_single_value("show_ticker_index", scope.ticker_index['render']['ticker_index'])
	with col3:show_config_single_value("industry_report", scope.ticker_index['render']['industry_report'])
	with col4:show_config_single_value("save_edited_df", scope.ticker_index['render']['save_edited_df'])
	with col5:show_config_single_value("editable_df", scope.ticker_index['render']['editable_df'])
	with col6:show_config_single_value("editable_df_key", scope.ticker_index['render']['editable_df_key'])
